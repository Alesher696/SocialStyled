...
const ProfilePage = lazy(()=> import('common/components/profile/Profile')
    .then(module => ({default: module.Profile})))

const DialogsPage = lazy(()=> import("common/components/dialogs/Dialogs")
    .then(module => ({default: module.Dialogs})))

const UsersPage = lazy(()=> import("common/components/users/Users")
